 ...
 * 结构投影公开调用入口。
 */
public final class StructureProjectionApi {
    private StructureProjectionApi() {
    }

    /**
     * 显示一个新的结构投影；若已有旧投影，会被新的替换。
     */
    public static boolean show(StructureTemplate template, BlockPos origin) {
     ...
     */
    public static boolean show(StructureTemplate template, BlockPos origin, Collection<Item> moveControlItems) {
