...
public final class GuideDocumentCache {
    ...
    private static final PreparableReloadListener RELOAD_LISTENER =
        new SimplePreparableReloadListener<Map<ResourceLocation, MDDocument>>() {
            @Override
            protected Map<ResourceLocation, MDDocument> prepare(ResourceManager resourceManager, ProfilerFiller profiler) {
                ...
                for (Map.Entry<ResourceLocation, Resource> entry : resources.entrySet()) {
                    ...
                    try (var stream = entry.getValue().open()) {
                        ...
                        prepared.put(location, parser.parseDocument(location, markdown));
            ...
            protected void apply(
                Map<ResourceLocation, MDDocument> prepared,
                ResourceManager resourceManager,
                ProfilerFiller profiler
            ) {
                PARSED_DOCUMENT_CACHE = Map.copyOf(prepared);
